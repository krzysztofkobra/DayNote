          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-8">
            ...
            <div>
              <label className="block mb-3 font-medium text-gray-800 flex items-center space-x-2">
                <Globe size={20} /> <span>Timezone</span>
              </label>
              <select
                value={timezone}
            ...
            <div>
              <label className="block mb-3 font-medium text-gray-800 flex items-center space-x-2">
                <BookText size={20} /> <span>Language</span>
              </label>
              <select
                value={language}
            ...
            <div>
              <label className="block mb-3 font-medium text-gray-800 flex items-center space-x-2">
                <CalendarDays size={20} /> <span>Start of Week</span>
              </label>
            ...
            <div>
              <label className="block mb-3 font-medium text-gray-800 flex items-center space-x-2">
                <Eye size={20} /> <span>Calendar Default View</span>
              </label>
              <div className="flex space-x-4">
                <button
            ...
            <div>
              ...
              <div className="flex items-center space-x-5">
                ...
                ><Sun size={18} className="mr-2" /> Light</button>
                <button
                ...
                ><Moon size={18} className="mr-2" /> Dark</button>
              </div>
            </div>
          </div>
        </div>
